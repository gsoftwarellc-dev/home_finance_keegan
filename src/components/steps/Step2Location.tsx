...
export default function Step2Location({ form, update }: Props) {
  return (
    <div>
      <h2 style={{ fontSize: 24, fontWeight: 800, color: '#0f172a', margin: '0 0 6px' }}>Where Is Your Property?</h2>
      <p style={{ fontSize: 14, color: '#64748b', margin: '0 0 28px' }}>
        Lender availability varies by location. This helps us show the most relevant options.
      </p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 20 }}>
        ...
        <div style={{ gridColumn: '1 / -1' }}>
          ...
          <select value={form.state} onChange={(e) => update({ state: e.target.value })} style={{ ...inputStyle, appearance: 'auto' }}>
